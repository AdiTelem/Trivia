...
def get_and_print(sock, decode=True):
    """
...
def talk_with_server(sock):
    ...
    print("Test1: username login without signup")
    login(sock, "randomUser", "123456")

    print("Test2: username signup with same name twice")
    signup(sock, "signTwice", "123456", "email@gmail.com")

    print("Test3: username login where already online")
    login(sock, "itamar", "adsad")
    login(sock, "itamar", "adsad")
